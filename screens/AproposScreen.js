...
import { 
  ...
  Modal, // Nampiana ho an'ny sary lehibe
  Dimensions // Nampiana ho an'ny fitantanan-kabe
} from 'react-native';
import { useTheme } from '../contexts/ThemeContext';
import MyImage from '../assets/images/IMG_4214.JPG'; 

// Mba ahazoana ny haben'ny efijery
...
const AideScreen = () => {
  ...
  // State vaovao ho an'ny Modal Viewer
  ...
  // Fiasana vaovao: Manokatra ny Modal hijerena ny sary lehibe
  const handleImagePress = () => {
    setModalVisible(true); 
  };
  
  // Fiasana vaovao: Manidy ny Modal
  const closeModal = () => {
  ...
  return (
    <ScrollView contentContainerStyle={[styles.container, { backgroundColor: theme.colors.background }]}>
      ...
      <View style={styles.header}>
        {/* FANAMBOARANA: Fanaovana ny sary ho clickable sy miantso ny handleImagePress */}
      ...
      {/* MODAL: Hiseho rehefa tsindriana ilay sary logo */}
      <Modal
        animationType="fade" 
        transparent={true}
...
// STYLES FANAMPINY HO AN'NY MODAL
const modalStyles = StyleSheet.create({
  centeredView: {
    flex: 1,
    justifyContent: 'center',
    alignItems: 'center',
    backgroundColor: 'rgba(0, 0, 0, 0.95)', // Background mainty
  },
  fullImage: {
    width: width * 0.9, 
    height: height * 0.7, 
